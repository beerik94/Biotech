...
public class tileEntityDnaSpawner extends tileEntityBasicMachine
{
	...
	public void SpawnMob(int dnaDamage)
	{
		...
		{
			case 0:
				// par1Entity = new bioChicken(worldObj, this.xCoord, this.yCoord + 1, this.zCoord,
				// health, width, height, drops, EV);
				//worldObj.spawnEntityInWorld(par1Entity);
				break;
			case 1:
				// par1Entity = new bioCow(worldObj, this.xCoord, this.yCoord + 1, this.zCoord,
				// health, width, height, drops, EV);
				//worldObj.spawnEntityInWorld(par1Entity);
				break;
			case 2:
				// par1Entity = new bioPig(worldObj, this.xCoord, this.yCoord + 1, this.zCoord,
				// health, width, height, drops, EV);
				//worldObj.spawnEntityInWorld(par1Entity);
				break;
			case 3:
				// par1Entity = new bioSheep(worldObj, this.xCoord, this.yCoord + 1, this.zCoord,
				// health, width, height, drops, EV);
				//worldObj.spawnEntityInWorld(par1Entity);
				break;
		}
