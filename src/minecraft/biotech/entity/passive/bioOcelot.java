...
import biotech.entity.ai.bioEntityAIOcelotSit;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class bioOcelot extends EntityTameable
{
    /**
    ...
    public bioOcelot(World par1World)
    {
        super(par1World);
        ...
        this.tasks.addTask(6, new bioEntityAIOcelotSit(this, 0.4F));
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof bioOcelot))
        {
            return false;
        }
        else
        {
            bioOcelot entityocelot = (bioOcelot)par1EntityAnimal;
