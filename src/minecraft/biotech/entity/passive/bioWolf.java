...
import biotech.entity.ai.bioEntityAIBeg;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class bioWolf extends EntityTameable
{
    ...
    public bioWolf(World par1World)
    {
        super(par1World);
        ...
        this.tasks.addTask(8, new bioEntityAIBeg(this, 8.0F));
     ...
     */
    public bioWolf spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        bioWolf entitywolf = new bioWolf(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof bioWolf))
        {
            return false;
        }
        else
        {
            bioWolf entitywolf = (bioWolf)par1EntityAnimal;
