...
public class WorkerGui extends GuiContainer {
	...
	public WorkerGui(InventoryPlayer playerInventory,
			BasicWorkerTileEntity tileEntity) {
	...
	protected void drawGuiContainerForegroundLayer(int i, int j) {
		...
		// fontRenderer.drawString("Power: " + grinder.powerFlow + " J / T", 70,
		// 60, 0xFFFFFF);
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
		 ...
		 * this.drawTexturedModalRect(x + 79, y + 34, 176, 14, progress + 1,
		 * 16);
		 */
	}
}