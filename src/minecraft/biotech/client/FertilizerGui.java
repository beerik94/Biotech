...
public class FertilizerGui extends GuiContainer
{
	...
	public FertilizerGui(InventoryPlayer playerInventory, FertilizerTileEntity tileEntity)
	{
		super(new FertilizerContainer(playerInventory, tileEntity));
