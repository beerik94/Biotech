...
import gigaherz.biotech.FakePlayer;
...
public class commandCircuitItem extends Item
{
    ...
    private boolean hasToolOf(BasicWorkerTileEntity workerTile, ItemStack... stacks)
    {
    ...
    private boolean hasOneOf(BasicWorkerTileEntity workerTile, ItemStack... stacks)
    {
        for (int i = 0; i < stacks.length; i++)
        {
