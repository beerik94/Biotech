...
public class TillingMachineGui extends GuiContainer
{
    ...
    public static String TILLINGMACHINE_GUI = Biotech.FILE_PATH + "tillingmachine.png";
    
	private int containerWidth;
	private int containerHeight;
    
    public TillingMachineGui(InventoryPlayer playerInventory, TillingMachineTileEntity tillingMachine)
    {
